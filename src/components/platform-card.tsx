      ...
      return (
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-semibold text-codecracker-amber">{leetcodeStats.streak} days</span>
          </div>
        </div>
      );
    }
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex">
              {Array.from({ length: codechefStats.stars }).map((_, i) => (
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm font-medium">Problems Solved</span>
            <span>{codechefStats.problemsSolved}</span>
          </div>
        </div>
      );
    }
